...
echo "Leader calibration starts in this terminal."
echo "At each prompt:"
echo "  - Press ENTER to reuse an existing calibration file."
echo "  - Type c then ENTER to recalibrate that arm."
echo "During recalibration, physically move only the prompted arm through its range."
echo
